...
import { generateUrlToken, hashUrlToken } from "../utils/otp";
import OTP from "../models/otpCode.model";
import {
...
import { IUser } from "../__types__/user.types";

const sendApprovalReminder = async (user: IUser) => {
...
export const approveVendorAccount = AsyncHandler(
