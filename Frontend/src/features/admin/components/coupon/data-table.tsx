...
export function DataTable<TData extends CouponT, TValue>({
  columns,
}: DataTableProps<TData, TValue>) {
  const { data: couponData, isPending, isError } = useGetAllCoupons()

  const tableData: TData[] = (couponData as TData[]) || []
